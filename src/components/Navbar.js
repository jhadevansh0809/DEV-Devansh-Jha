  ...
  return (
    ...
    <div className='nav h-20 bg-black text-white flex justify-evenly items-center sm:justify-between sm:px-3 sm:flex-col'>
        ...
        <ul className='text-sm w-2/5 flex justify-between items-center lg:w-3/5 sm:hidden z-10' id='navLinks'>
           <Link to='/'><li className='sm:my-5'>About</li></Link>
           <Link to='/skills'><li className='sm:my-5'>Skills</li></Link>
           <Link to='/projects'><li className='sm:my-5'>Projects</li></Link>
           <a href={resume} target='_blank'><li className='sm:my-5'>Resume</li></a>
           <Link to='/contact'><li className='sm:my-5'>Contact</li></Link>
        </ul>
    </div>
